...
export declare enum TrendbarPeriod {
    /** 1 minute. */
    M1 = 1,
    /** 2 minutes. */
    M2 = 2,
...
export declare enum OrderTriggerMethod {
...
export declare enum SymbolDistanceType {
    /** Distance in points. */
...
export declare enum MinCommissionType {
    /** Base currency. */
    CURRENCY = 1,
    /** Quote currency. */
    QUOTE_CURRENCY = 2
...
export declare enum SwapCalculationType {
    /** Swap in pips. */
    PIPS = 0,
    /** Swap as percentage. */
    PERCENTAGE = 1,
...
export declare enum TotalMarginCalculationType {
...
export declare enum LimitedRiskMarginCalculationStrategy {
    /** Use leverage. */
...
export declare enum StopOutStrategy {
...
export declare enum ClientPermissionScope {
    /** Read-only access. */
    SCOPE_VIEW = 0,
    /** Trading access. */
    SCOPE_TRADE = 1
...
export declare enum ChangeBonusType {
    /** Bonus added. */
    BONUS_DEPOSIT = 0,
    /** Bonus removed. */
    BONUS_WITHDRAW = 1
...
export declare enum ChangeBalanceType {
    BALANCE_DEPOSIT = 0,
    BALANCE_WITHDRAW = 1,
...
export declare enum ProtoErrorCode {
    /** Unknown error. */
    UNKNOWN_ERROR = 1,
